...
use crate::{material::ripple::Ripple, util::ColorConversion, THEME};
...
pub fn Button(props: ButtonProps) -> Element {
    ...
    let (background, color, border) = match kind {
        ...
        ButtonKind::Filled => (THEME.primary.to_rgb(), THEME.on_primary.to_rgb(), TRANSPARENT.to_rgba()),
        ButtonKind::Tonal => (
            THEME.primary_container.to_rgb(),
            THEME.on_primary_container.to_rgb(),
            TRANSPARENT.to_rgba(),
        ),
        ButtonKind::Outlined => (TRANSPARENT.to_rgba(), THEME.primary.to_rgb(), THEME.outline.to_rgb()),
        ButtonKind::Text => (TRANSPARENT.to_rgba(), THEME.primary.to_rgb(), TRANSPARENT.to_rgba()),
    };
